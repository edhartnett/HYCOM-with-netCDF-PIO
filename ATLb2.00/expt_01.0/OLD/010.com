...
C
  ...
  if (-z forcing.precip.a) then
     ${pget} ${D}/../../force/${FN}/precip_zero.a forcing.precip.a &
  endif
  if (-z forcing.precip.b) then
     ${pget} ${D}/../../force/${FN}/precip_zero.b forcing.precip.b &
  endif
...
if (-z forcing.rivers.a) then
   ${pget} ${D}/../../force/rivers/rivers.a forcing.rivers.a &
endif
if (-z forcing.rivers.b) then
   ${pget} ${D}/../../force/rivers/rivers.b forcing.rivers.b &
endif
C
