...
c
     ...
     &                depthu,depthv,pvtrop,depths,drag,topiso
      save  /hycom3r/
c
      real, dimension (1-nbdy:idm+nbdy,1-nbdy:jdm+nbdy) ::
     ...
     &                sgain,surflx,sswflx,mixflx,
     &                sstflx,sssflx,salflx,buoflx,bhtflx,
     &                ustar,ustarb,turgen,thkice,covice,temice
      save  /hycom4r/
c
      integer, dimension (1-nbdy:idm+nbdy,1-nbdy:jdm+nbdy) ::
     & klist,         ! k-index
...
c
     ...
     &              mxlmy,mxlpwp,mxlgiss,flxoff,flxsmo,trcrin,trcout
      common/swtchs/diagno,thermo,windf,
     &              pcipf,epmass,priver,rivera,kparan,
     &              relax,srelax,trelax,trcrlx,relaxf,relaxs,relaxt,
     &              locsig,vsigma,hybrid,isopyc,icegln,
     &              mxlkta,mxlktb,mxlkrt,pensol,
...
c
     ...
     &               sigjmp,tmljmp,salmin(kdm)
      save  /parms1r/
c
      integer        tsofrq,mixfrq,nhybrd,nsigma,
     ...
     &               flxflg,empflg,lwflag,sstflg,sssflg
      common/parms1i/tsofrq,mixfrq,nhybrd,nsigma,
     &               hybflg,advflg,advtyp,
     &               kapref,kapnum,
     &               ntracr,trcflg,
     &               clmflg,dypflg,iniflg,lbflag,mapflg,yrflag,
