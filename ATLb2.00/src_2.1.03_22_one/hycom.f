...
c
     ...
     &        coord,day1,day2,x,x1,time0,timav,cold,utotp,vtotp
      integer nstep0,nod,
     &        lt,ma0,ma1,ma2,ma3,mc0,mc1,mc2,mc3,mr0,mr1,mr2,mr3,mnth,
     &        iday,ihour,iyear
*     integer index
...
c
     ...
     &            mod(dtime+dsmall,days6).lt.dsmall2
         ...
         if (mxlkpp) then
               ...
               call xctmr0(48)
               call xctmr1(48)
         else  ! mxlpwp has dypflg=2, mxlmy has dypflg=0
               call xctmr0(47)
            call convch(m,n)
               call xctmr1(47)
               call pipe_comparall(m,n, 'convch, step')
           if     (dypflg.eq.1) then  ! KPP-like
                 call xctmr0(48)
              call diapf1(m,n)
                 call xctmr1(48)
                 call pipe_comparall(m,n, 'diapf1, step')
           elseif (dypflg.eq.2) then  ! explicit
                 call xctmr0(48)
              call diapf2(m,n)
                 call xctmr1(48)
