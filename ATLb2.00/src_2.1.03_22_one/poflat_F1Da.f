...
c
      integer    kdpth,klat
      parameter (kdpth=7,klat=5)  ! kdpth>1, klat>3
c
      real onem,thet1,thet2,dthet,xlat1,xlat2,dlat
      real pdat(kdpth,klat)
c
      data onem/9806./  ! SI units
      data thet1,thet2,dthet/23.65,25.03,0.23/
      data xlat1,xlat2,dlat/-90.0,90.0,45.0/
c
c---  depth (m) of isopycnals of potential density 23.65,23.88,..,25.03
c---  at latitudes  90s ... 90n  for F1Da (1-D in 100m, linear profile)
c
      data pdat /  ! linear profile
     + 0.0,16.67,33.33,50.00,66.67,83.33,100.0  !90s
     +,0.0,16.67,33.33,50.00,66.67,83.33,100.0  !45s
     +,0.0,16.67,33.33,50.00,66.67,83.33,100.0  ! 0 
     +,0.0,16.67,33.33,50.00,66.67,83.33,100.0  !45n
     +,0.0,16.67,33.33,50.00,66.67,83.33,100.0  !90n
     &/
c
