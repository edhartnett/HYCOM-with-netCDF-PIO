...
endsw
C
C --- Create HYCOM wndspd data file from a monthly atmos. climatology.
C
switch ($OS)
case 'SunOS':
    if (-e /scr) then
...
touch      fort.71
/bin/rm -f fort.71
ln -s    ~metzger/force/${N}/monthly/${W}_wndspd.D fort.71  &
#${pget} ~metzger/force/${N}/monthly/${W}_wndspd.D fort.71  &
C
...
C --- Output.
C
/bin/mv fort.10  ./wndspd.b
/bin/mv fort.10A ./wndspd.a
C
${pput} wndspd.b ${D}/wndspd.b
${pput} wndspd.a ${D}/wndspd.a
C
C --- Delete all files.
C
/bin/rm -f fort.* ./kp
