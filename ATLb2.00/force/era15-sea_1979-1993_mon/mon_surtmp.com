...
endsw
C
C --- Output, note that this is surface temperature not necessarily SST.
C
/bin/mv fort.10  ./surtmp.b
/bin/mv fort.10A ./surtmp.a
C
${pput} surtmp.b ${D}/surtmp.b
${pput} surtmp.a ${D}/surtmp.a
C
C --- Delete all files.
C
/bin/rm -f fort.* ./kp
