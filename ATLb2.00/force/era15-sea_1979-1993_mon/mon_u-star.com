...
endsw
C
C --- Create HYCOM u-star data file from a monthly atmos. climatology.
C
switch ($OS)
case 'SunOS':
    if (-e /scr) then
...
touch      fort.71
/bin/rm -f fort.71
ln -s    ~metzger/force/${N}/monthly/${W}_u-star.D fort.71  &
#${pget} ~metzger/force/${N}/monthly/${W}_u-star.D fort.71  &
C
...
C --- Output.
C
/bin/mv fort.10  ./u-star.b
/bin/mv fort.10A ./u-star.a
C
${pput} u-star.b ${D}/u-star.b
${pput} u-star.a ${D}/u-star.a
C
C --- Delete all files.
C
/bin/rm -f fort.* ./kp
