...
#
setenv NCARG_GKS_PS 013y021w_fsd+cur+bot_2.ps
setenv OVERLAY VECBATH
setenv ARROW_XEDGE      1.1
setenv ARROW_YEDGE      1.1
setenv ARROW_UNITS      "CM/S"
setenv ARROW_PLTHICK    3.0
setenv ARROW_PLCOLOR    1
setenv CONTOUR_PLTHICK  3.0
setenv CONTOUR_PLCOLOR  0
#
./src/fieldtest <<'E-o-D'
../expt_01.3/data/archv.0021_016_00_fsd.a
../expt_01.3/data/archv.0021_016_00_3du.a
../expt_01.3/data/archv.0021_016_00_3dv.a
500.0	'qqbath' = bathymetry contour interval (<0 no plot; 0 from field)
ATLb2.00
 ...
 11	'locbar' = location of the color bar     (1[0-4]=vert,2[0-4]=horiz)
  ...
  2	'i_th  ' = draw a vector in only every i_th column
  2	'j_th  ' = draw a vector in only every j_th row
...
100.0	'vscale' = scale factor for vector (convert to cm/s)
 25.0	'vrefmx' = velocity plot maximum (streamline vectors)
