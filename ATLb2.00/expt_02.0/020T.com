...
foreach y ( 2003 2004 2005 2006 2007 )
  ...
  if (-z fort.${N}) then
    if     ($y >= 2003) then
      ${pget} ${W}/3hourly/nogaps0.5c-sea_${y}_03hr_soiltm.D fort.${N} &
    else
      ${pget} ${W}/6hourly/nogaps1.0a-sea_${y}_06hr_soiltm.D fort.${N} &
    endif
#   ${pget} ${W}/era40-sea_${y}_06hr_soiltm.D fort.${N} &
  endif
end
C
C --- executable
...
cat <<E-o-D  > fort.05in
 &AFTITL
  ...
  CTITLE = 'NOGAPS 0.5c, 3-hrly, ocn-only, degC',
  CNAME  = 'surtmp',
 &END
 &AFTIME
  FSTART = ${TS},
