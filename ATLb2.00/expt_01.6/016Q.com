...
C
touch  fort.71 fort.72 fort.73
if (-z fort.71) then
  ${pget} ${W}/ds111.3_ecmwf-oper_1999_06hr_Qt.D fort.71 &
endif
if (-z fort.72) then
  ${pget} ${W}/ds111.3_ecmwf-oper_2000_06hr_Qt.D fort.72 &
endif
if (-z fort.73) then
  ${pget} ${W}/ds111.3_ecmwf-oper_2001_06hr_Qt.D fort.73 &
endif
C
C --- executable
C
...
cat <<E-o-D  >! fort.05i
 &AFTITL
  ...
  CTITLE = 'ECMWF total flux, masked, 6hrly, W/m^2',
  CNAME  = 'totflx',
 /
 &AFTIME
