...
if (-z fort.71) then
  ${pget} ${W}/ds111.13_ecmwf-oper_9801_06hr_TaqaQrQp.d fort.71 &
endif
if (-z fort.72) then
  ${pget} ${W}/ds111.13_ecmwf-oper_0205_06hr_TaqaQrQp.d fort.72 &
endif
C
C --- executable
C
...
cat <<E-o-D  >! fort.05i
 &AFTITL
  ...
  CTITLE = 'ECMWF DS111.13 6hrly, masked, MKS',
 /
 &AFTIME
  BIASPC =   0.0,
  BIASRD = -14.0,
